...
description: 'Prader-Willi syndrome (PWS) and Angelman syndrome (AS) are diseases
  ...
  Due to methylation patterns however, different genes are responsible for the two
  syndromes. For this chromosomal region, also duplications are known.  A detailed
  description of the syndromes in this region and the molecular pathway has been published
  by Ehrhart et al. (https://doi.org/10.1080/15622975.2018.1439594). '
pubmed_ids:
- '21248749'
- '25077648'
- '19455185'
